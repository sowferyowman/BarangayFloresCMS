...
export function Login({ ok }: { ok: () => void }) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (await store.login(username, password)) {
      ok();
    } else {
